...
{
    public static class SortClassHelper
    {

        private static pr_GetItemLedger_Result ForSortTempLabel = new pr_GetItemLedger_Result();
        private static pr_GetItemLedger_Result[] TempSortItems = null;
        //SORTS
        public static pr_GetItemLedger_Result[] SortHelper(pr_GetItemLedger_Result[] DataSort, string Xnametxt)
        {
            switch (Xnametxt)
            {
